...
if __name__ == "__main__":
    bwu = TIMESTAP*100//8
    cmd = [
        "iperf3 -c 10.0.0.1 -B 10.0.0.2 --cport 12345 -n %sM -p 5201"%(bwu*1),
        "iperf3 -c 10.0.0.1 -B 10.0.0.2 --cport 12346 -n %sM -p 5202"%(bwu*2),
        "iperf3 -c 10.0.0.1 -B 10.0.0.2 --cport 12347 -n %sM -p 5203"%(bwu*3)
    ]
    start_time = [
        0*TIMESTAP, 0*TIMESTAP, 0*TIMESTAP
    ]
    print("Starting...")
    i = 0
    while True:
